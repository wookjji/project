...
.btn{ width: 60px; height: 30px; color: white; font-size: 15px;
...
<%@ include file="./common/main.jsp" %>
	...
	<div class="container">
		<article>
			<b style="font-size: 40px;">문의글 수정하기 </b>
			<br><br>
			
			<form action="/q_detail" method="post">
				<div class="title">
					<b style="font-size: 20px;"> 제목 :</b>
					<textarea class="text" name="title">${qna.q_title }</textarea>
				</div>
				<div>
					<textarea class="write" id="content" name="content" maxlength="1000" rows="30">${qna.q_content}</textarea>
				</div>
				<br>
				<div class="save_btn">
					<input type="hidden" id="qno" name="qno" value=${qna.q_no }>
